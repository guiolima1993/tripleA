  ...
  return (
    <section className="upsell-section">
      <div className="content-container">
        ...
        <h1 className="upsell-headline">Você tem uma Ferrari nas mãos, mas precisa do principal…</h1>

        <p className='upsell-subheadline'>Gasolina para acelerar! Veja como vou potencilizar o resultado no seu negócio.</p>
